...
namespace ModsAPI.Controllers
{
    ...
    public class ApproveController : ControllerBase
    {
        ...
        /// 审核Mod版本
        /// </summary>
        /// <param name="json">ModId:ModId，Comments:审批意见，Status:状态{Approved = 20, Rejected = 10, Pending = 0} json示例：{"ModId":"","Comments":"","Status":""}</param>
        /// <returns></returns>
        [HttpPost(Name = "")]
        public ResultEntity<string> ApproveMod([FromBody] dynamic json)
        {
            ...
            _IModService.ApproveModVersionAsync(ModId, UserId, Status, Comments);
