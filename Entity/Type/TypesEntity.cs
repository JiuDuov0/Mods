...
namespace Entity.Type
{
    ...
    public class TypesEntity
    {
        public List<TypesEntity> GetRoleList()
        {
            ...
            {
                new TypesEntity(){ Id = "52F94622-FA0A-74C2-0AC1-11B06B5B1D86", TypeName = "视觉" },
                new TypesEntity(){ Id = "4708E8C8-4D4C-093F-9C53-50E8312D745A", TypeName = "音频" },
                new TypesEntity(){ Id = "6C38D615-8CC7-336D-324A-69F26F9FE62D", TypeName = "框架" },
                new TypesEntity(){ Id = "BB13FD20-F807-E987-7391-4E757F4C684E", TypeName = "改变游戏玩法" },
                ...
                new TypesEntity(){ Id = "F15583FF-9F23-B4AB-104F-89539A6A6C07", TypeName = "工具" }
            };
        }
        [Key]
