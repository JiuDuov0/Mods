...
namespace Entity.Type
{
    ...
    public class TypesEntity
    {
        public List<TypesEntity> GetRoleList()
        {
            ...
            {
                new TypesEntity(){ TypesId = "52F94622-FA0A-74C2-0AC1-11B06B5B1D86", TypeName = "视觉", Sort = 0 },
                new TypesEntity(){ TypesId = "4708E8C8-4D4C-093F-9C53-50E8312D745A", TypeName = "音频", Sort = 1 },
                new TypesEntity(){ TypesId = "6C38D615-8CC7-336D-324A-69F26F9FE62D", TypeName = "框架", Sort = 2 },
                ...
                //new TypesEntity(){ TypesId = "624513D9-A604-D708-6067-3DE518C80A26", TypeName = "" },
